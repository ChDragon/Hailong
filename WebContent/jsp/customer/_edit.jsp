	...
	<div class="panel-body" style="padding: 50px">
		<FORM id=form1 name=form1 class="form-horizontal" role="form"
			...
			<div class="form-group" style="padding: 10px">
				...
				<div class="col-sm-3">
					<input type="text" class="form-control" id="inputEmail3"  name="custName" value=<s:property value="custName"/>>
				</div>
				<label for="inputPassword3" class="col-sm-2 control-label">客户级别:</label>
				<div class="col-sm-3">
					<input type="text" class="form-control" id="inputPassword3"  name="custLevel" value=<s:property value="custLevel"/>>
				</div>
			...
			<div class="form-group" style="padding: 10px">
				...
				<div class="col-sm-3">
					<input type="text" class="form-control" id="inputEmail3" name="custSource" value=<s:property value="custSource"/>>
				</div>
				<label for="inputPassword3" class="col-sm-2 control-label">联系人:</label>
				<div class="col-sm-3">
					<input type="text" class="form-control" id="inputPassword3" name="custLinkman" value=<s:property value="custLinkman"/>>
				</div>
				<div class="col-sm-1"></div>
			</div>
